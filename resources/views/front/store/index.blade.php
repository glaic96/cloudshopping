...
<link href="{{ asset('public/front/store/css/bootstrap.css') }}" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="{{ asset('public/front/store/js/jquery.min.js') }}"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="{{ asset('public/front/store/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<script type="text/javascript" src="{{ asset('public/front/store/js/move-top.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/front/store/js/easing.js') }}"></script>
...
<!-- start menu -->
<link href="{{ asset('public/front/store/css/megamenu.css') }}" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="{{ asset('public/front/store/js/megamenu.js') }}"></script>
<script>$(document).ready(function(){$(".megamenu").megamenu();});</script>

<script src="{{ asset('public/front/store/js/simpleCart.min.js') }}"> </script>
</head>
<body> 
<!--header-->	
<div class="header" >
	<div class="top-header" >		
		...
		<div class="head-top">
			<div class="logo">
				<a href="index.html"><img src="{{ asset('public/front/store/images/logo.png') }}" alt="" ></a>
			</div>
		<div class="top-nav">		
				  ...
				  <div class="megapanel">
					...
					<div class="cart box_1">
						...
						<h3> <div class="total">
							...
							<img src="{{ asset('public/front/store/images/cart.png') }}" alt=""/></h3>
						</a>
						<p><a href="javascript:;" class="simpleCart_empty"><img src="{{ asset('public/front/store/images/cart-c.png') }}"  alt=""></a></p>
						<div class="clearfix"> </div>
					</div>
...
<div class="container">	
		  <div class="wmuSlider example1">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	<div class="banner-wrap">
						...
						<div class="banner-top-in">
							<img src="{{ asset('public/front/store/images/ba.png') }}" class="img-responsive" alt="">
						</div></a>
						...
						<div class="banner-top-in at">
							<img src="{{ asset('public/front/store/images/ba2.png') }}" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
						...
						<a href="single.html">
						<div class="banner-top-in">
							<img src="{{ asset('public/front/store/images/ba11.png') }}" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
						...
						<div class="clearfix"> </div>
						  ...
						  <a href="single.html">
						<div class="banner-top-in at">
							<img src="{{ asset('public/front/store/images/ba21.png') }}" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
						...
						<a href="single.html">
						<div class="banner-top-in">
							<img src="{{ asset('public/front/store/images/ba12.png') }}" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
						...
						<div class="clearfix"> </div>
						  ...
						  <a href="single.html">
						<div class="banner-top-in at">
							<img src="{{ asset('public/front/store/images/ba22.png') }}" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
		...
		<!---->
		  <script src="{{ asset('public/front/store/js/jquery.wmuSlider.js') }}"></script> 
			  <script>
       			$('.example1').wmuSlider({
					 pagination : true,
					 nav : false,
...
<div class="content">
	<div class="container">
		...
		<link href="{{ asset('public/front/store/css/owl.carousel.css') }}" rel="stylesheet">
		<script src="{{ asset('public/front/store/js/owl.carousel.js') }}"></script>
			<script>
		...
		<!-- //requried-jsfiles-for owl -->
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="{{ asset('public/front/store/images/pi.jpg') }}" class="img-responsive" alt="">
							 	<div class="zoom-icon">
...
<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="{{ asset('public/front/store/images/pi11.jpg') }}" class="img-responsive" alt="">
							 	<div class="zoom-icon">
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="{{ asset('public/front/store/images/pi12.jpg') }}" class="img-responsive" alt="">
							 	<div class="zoom-icon">
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="{{ asset('public/front/store/images/pi13.jpg') }}" class="img-responsive" alt="">
							 	<div class="zoom-icon">
...
<div class="item">
			...
			<div class="col-md-4">
				<a href="single.html"><div class="col-in">
					<div class="col-in-left">
						<img src="{{ asset('public/front/store/images/ni.jpg') }}" class="img-responsive" alt="">
					</div>
					</a>
	...
	<div class="bottom-content">
			...
			<div class="col-md-4">
				<img src="{{ asset('public/front/store/images/ad1.png') }}" class="img-responsive" alt="">
			</div>
			<div class="col-md-4">
				<img src="{{ asset('public/front/store/images/ad1.png') }}" class="img-responsive" alt="">
			</div>
